...
public class Palindrome {
    public static void main(String[] args) {
        System.out.println("Is -1221 a palindrome? " + isPalindromeTwo(-1221)); // true
        System.out.println("Is 707 a palindrome? " + isPalindrome(707)); //
        System.out.println("Is 11212 a palindrome? " + isPalindromeTwo(11212)); // false
    }

    public static boolean isPalindrome(int number) {
        if (number < 0) {
            number = -number; // Make negative numbers positive
        }
        ...
        return originalNumber == reverse; // Check if original and reversed are the same
    }
